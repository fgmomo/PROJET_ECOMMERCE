...
@section('content')
    ...
    <div class="hero-wrap hero-bread" style="background-image:url('frontend/images/ig.jpg');">
      <div class="container">
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					...
    					<li><a href="/select_par_cat/{{$category->category_name}}" class="{{(request()->is('select_par_cat/'.$category->category_name)?'active':'')}}">{{$category->category_name}}</a></li>
                        @endforeach
