	    				...
	    				<table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <form action="{{url('/modify_qty/'.$product['product_id'])}}" method="POST">
                                        @csrf
                                        <td class="quantity">
                                            <div class="input-group mb-3">
                                            <input type="number" value="{{$product['qty']}}" name="quantity" class="quantity form-control input-number" value="1" min="1" max="100">
                                        </div>
